    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                ...
                <button class="btn btn-primary pull-right" type="submit"><i class="ion-ios-download"></i> &nbsp; <?php echo lang('add'); ?></button>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <?php echo form_input('title', set_value('title'), ['class' => 'form-control', 'id' => 'title', 'required' => 'required']); ?>
                        </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <?php echo form_textarea('content', set_value('content'), ['id' => 'content']); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <?php echo form_input('meta_keywords', set_value('meta_keywords'), ['class' => 'form-control', 'id' => 'meta_keywords']); ?>
                        </div>

                        <!-- meta_description -->
                        <div class="form-group">
                            <label for="meta_description"><?php echo lang('meta').' '.lang('description'); ?></label>
                            <?php echo form_textarea('meta_description', set_value('meta_description'), ['class' => 'form-control', 'id' => 'meta_description']); ?>
                        </div>
